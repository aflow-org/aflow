...
#ifndef SYMBOLIC_CPLUSPLUS_MAIN_DEFINE //DX20200824 - added for proper compilation
#define SYMBOLIC_CPLUSPLUS_MAIN_DEFINE //DX20200824 - added for proper compilation
#include "symbolicc++.h"
...
namespace symbolic{ //DX20200625
  ...
  ostream &operator<<(ostream &o,const std::list<Symbolic> &e)
  {
