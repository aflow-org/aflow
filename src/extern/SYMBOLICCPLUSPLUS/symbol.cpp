...
namespace symbolic{ //DX20200625
  ...
  Cloning *Symbol::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added Symbol class to *clone()
  ...
  Cloning *UniqueSymbol::clone() const { return Cloning::clone(*this); } //DX20200825 - moved from h file and added UniqueSymbol class to *clone()
