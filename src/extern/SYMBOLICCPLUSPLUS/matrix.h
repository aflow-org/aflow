...
namespace symbolic { // DX20200625
  ...
  public:
    ...
    [[nodiscard]] Vector<T> vec() const;
    [[nodiscard]] Matrix<T> kron(const Matrix<T> &) const;
    [[nodiscard]] Matrix<T> dsum(const Matrix<T> &) const;
    [[nodiscard]] Matrix<T> hadamard(const Matrix<T> &) const;
    [[nodiscard]] std::pair<Matrix<T>, Matrix<T>> LU() const;
  ...
  template <class T> Matrix<T> hadamard(const Matrix<T> &s, const Matrix<T> &m);

  template <class T> int operator==(const Matrix<T> &m1, const Matrix<T> &m2);
