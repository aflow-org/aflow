...
#ifndef SYMBOLIC_CPLUSPLUS_RATIONAL_DEFINE //DX20200824 - added for proper compilation
#define SYMBOLIC_CPLUSPLUS_RATIONAL_DEFINE //DX20200824 - added for proper compilation
