...
namespace symbolic { // DX20200625
  ...
  public:
    ...
    Polynomial(const Polynomial<T>& p) : variable(p.variable), terms(p.terms) {}
    ...
    Polynomial<T> karatsuba(const Polynomial<T>&, const Polynomial<T>&, int) const;
    ...
    Polynomial<T> Diff(const std::string&) const;
    Polynomial<T> Int(const std::string&) const;
    ...
    std::ostream& output1(std::ostream&) const;
    std::ostream& output2(std::ostream&) const;
    [[nodiscard]] int constant() const;
  ...
  template <class T> Polynomial<T> operator+(const T&, const Polynomial<T>&);
  template <class T> Polynomial<T> operator-(const T&, const Polynomial<T>&);
  template <class T> Polynomial<T> operator*(const T&, const Polynomial<T>&);
  template <class T> Polynomial<T> operator/(const T&, const Polynomial<T>&);
  template <class T> Polynomial<T> operator%(const T&, const Polynomial<T>&);
  template <class T> int operator==(T, const Polynomial<T>&);
  template <class T> int operator!=(T, const Polynomial<T>&);
