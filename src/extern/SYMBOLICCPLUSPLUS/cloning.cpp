...
namespace symbolic{ //DX20200625
  ...
  template CastPtr<symbolic::CloningSymbolicInterface>::CastPtr();
  ...
  template symbolic::CloningSymbolicInterface &CastPtr<symbolic::CloningSymbolicInterface>::operator*() const;
} //namespace symbolic //DX20200625
