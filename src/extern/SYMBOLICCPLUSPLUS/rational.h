...
namespace symbolic { // DX20200625
  ...
  public:
    ...
    operator double() const;
        ...
        // Member functions
    [[nodiscard]] T num() const;            // numerator of r
    [[nodiscard]] T den() const;            // denominator of r
    [[nodiscard]] Rational<T> frac() const; // fractional part of r
  ...
  template <class T> typename Rational<T>::output_type Rational<T>::output_preference = Rational<T>::fraction;
