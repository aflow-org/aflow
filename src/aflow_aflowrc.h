...
#define AFLOWRC_DEFAULT_AFLOW_DIELECTRIC_FILE std::string("OUTCAR.dielectric")
#define DEFAULT_AFLOW_DIELECTRIC_FILE XHOST.adefault.getattachedscheme("DEFAULT_AFLOW_DIELECTRIC_FILE")
...
#define AFLOWRC_DEFAULT_VASP_POTCAR_DIRECTORIES                                                                                                                                                                 \
  std::string(                                                                                                                                                                                                  \
      "/common/VASP,/common/AFLOW/VASP,/home/aflow/common/AFLOW/VASP,/fslhome/fslcollab8/group/VASP,/fslhome/glh43/src/,/share/home/00470/tg457283/common/AFLOW/VASP/,/share/home/00457/tg457357/common/AFLOW/" \
      "VASP/,/home/mehl/bin/AFLOW/VASP/,~/common/VASP/,~/common/AFLOW/VASP/,/home/aflow/common/VASP/,/nics/a/proj/aflow/common/AFLOW/VASP/,/home/users/aflow/common/VASP,/share/apps/AFLOW3/VASP,/share/apps/"  \
      "vasp/PP,/projects/kyang-group/common/VASP,/home/Tools/src/vasp/,/somewhere/")  // first is default, tokenized with "," //DX20190107 - added CMU path
...
#define AFLOWRC_DEFAULT_AFLOW_LIBRARY_DIRECTORIES                                                                                                                                                              \
  std::string(                                                                                                                                                                                                 \
      "/common/AFLOW/LIBS/,/home/aflow/common/AFLOW/LIBS/,/fslhome/glh43/src/,/usr/local/bin/,/fslhome/fslcollab8/group/bin/,/home/auro/work/AFLOW3/,~/common/AFLOW/LIBS/,./,/nics/a/proj/aflow/common/AFLOW/" \
      "LIBS/,/home/users/aflow/common/AFLOW/LIBS,/home/junkai/PROTO_DATABASE/,/projects/kyang-group/common/LIBS,/somewhere/")  // first is default, tokenized with ","
...
#define AFLOWRC_DEFAULT_AFLOW_PROJECTS_DIRECTORIES \
  std::string("/common/AUID,/common/ICSD,/common/LIB0,/common/LIB1,/common/LIB2,/common/LIB3,/common/LIB4,/common/LIB5,/common/LIB6,/common/LIB7,/common/LIB8,/common/LIB9") // first is default, tokenized with ","
...
// DEFAULT NHULL
#define AFLOWRC_DEFAULT_NHULL_ALLOWED_DFT_TYPES std::string("PAW_PBE,PAW_PBE_KIN")
#define DEFAULT_NHULL_ALLOWED_DFT_TYPES XHOST.adefault.getattachedscheme("DEFAULT_NHULL_ALLOWED_DFT_TYPES")
#define AFLOWRC_DEFAULT_NHULL_ALLOW_ALL_FORMATION_ENERGIES false
#define DEFAULT_NHULL_ALLOW_ALL_FORMATION_ENERGIES XHOST.adefault.getattachedutype<bool>("DEFAULT_NHULL_ALLOW_ALL_FORMATION_ENERGIES")
#define AFLOWRC_DEFAULT_NHULL_COUNT_THRESHOLD_BINARIES 200
#define DEFAULT_NHULL_COUNT_THRESHOLD_BINARIES XHOST.adefault.getattachedutype<int>("DEFAULT_NHULL_COUNT_THRESHOLD_BINARIES")
#define AFLOWRC_DEFAULT_NHULL_PERFORM_OUTLIER_ANALYSIS true
#define DEFAULT_NHULL_PERFORM_OUTLIER_ANALYSIS XHOST.adefault.getattachedutype<bool>("DEFAULT_NHULL_PERFORM_OUTLIER_ANALYSIS")
#define AFLOWRC_DEFAULT_NHULL_OUTLIER_ANALYSIS_COUNT_THRESHOLD_BINARIES 75
#define DEFAULT_NHULL_OUTLIER_ANALYSIS_COUNT_THRESHOLD_BINARIES XHOST.adefault.getattachedutype<int>("DEFAULT_NHULL_OUTLIER_ANALYSIS_COUNT_THRESHOLD_BINARIES")
#define AFLOWRC_DEFAULT_NHULL_OUTLIER_MULTIPLIER 3.25
#define DEFAULT_NHULL_OUTLIER_MULTIPLIER XHOST.adefault.getattachedutype<double>("DEFAULT_NHULL_OUTLIER_MULTIPLIER")
#define AFLOWRC_DEFAULT_NHULL_IGNORE_KNOWN_ILL_CONVERGED true
#define DEFAULT_NHULL_IGNORE_KNOWN_ILL_CONVERGED XHOST.adefault.getattachedutype<bool>("DEFAULT_NHULL_IGNORE_KNOWN_ILL_CONVERGED")
...
#define AFLOWRC_DEFAULT_POCC_JSON std::string("json")
#define DEFAULT_POCC_JSON XHOST.adefault.getattachedscheme("DEFAULT_POCC_JSON")
