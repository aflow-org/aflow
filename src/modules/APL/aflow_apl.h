...
// ***************************************************************************
  ...
  private:
    ...
    bool getMaps(const xstructure&, const xstructure&, const xstructure&, vector<int>&, vector<int>&) const;  // ME20200117
    void free();
  ...
  public:
    ...
    void trimStructure(int, const xvector<double>&, const xvector<double>&, const xvector<double>&, bool = true);
    ...
    [[nodiscard]] string getUniqueAtomSymbol(int) const;
    ...
    bool calcShellPhaseFactor(int, int, const xvector<double>&, xcomplex<double>&, int&, xvector<xcomplex<double>>&, bool);  // ME20180828
    ...
    [[nodiscard]] const vector<vector<_sym_op>>& getAGROUP() const;
    [[nodiscard]] const vector<_sym_op>& getFGROUP() const;
    [[nodiscard]] const vector<_sym_op>& getAGROUP(int) const;
...
// ***************************************************************************
  ...
  public:
    ...
    [[nodiscard]] const xvector<int>& getGrid() const;
    [[nodiscard]] const _qpoint& getIrredQPoint(int) const;
    [[nodiscard]] const _qpoint& getIrredQPoint(int, int, int) const;
    [[nodiscard]] vector<xvector<double>> getIrredQPointsCPOS() const;
    [[nodiscard]] vector<xvector<double>> getIrredQPointsFPOS() const;
    ...
    [[nodiscard]] const _qpoint& getQPoint(const xvector<double>&) const;  // ME20190813
    [[nodiscard]] int getQPointIndex(xvector<double>) const;  // ME20190813
    [[nodiscard]] int getQPointIndex(int, int, int) const;
    [[nodiscard]] vector<xvector<double>> getQPointsCPOS() const;
    [[nodiscard]] vector<xvector<double>> getQPointsFPOS() const;
    [[nodiscard]] int getIbzqpt(int) const;
    [[nodiscard]] int getIbzqpt(int, int, int) const;
    [[nodiscard]] const vector<int>& getIbzqpts() const;
    [[nodiscard]] const vector<_qpoint>& getPoints() const;
    [[nodiscard]] const _kcell& getReciprocalCell() const;
    [[nodiscard]] bool isShifted() const;  // ME20190813
    [[nodiscard]] const xvector<double>& getShift() const;
    ...
    [[nodiscard]] const vector<int>& getLittleGroup(int) const;  // ME20200109

      // Tetrahedron method
    void generateTetrahedra();
    void makeIrreducibleTetrahedra();

    [[nodiscard]] const vector<vector<int>>& getTetrahedra() const;
    [[nodiscard]] const vector<int>& getTetrahedron(int) const;
    [[nodiscard]] const vector<int>& getIrredTetrahedron(int) const;
    [[nodiscard]] int getTetrahedronCorner(int, int) const;
    [[nodiscard]] vector<vector<int>> getIrreducibleTetrahedra() const;
    [[nodiscard]] vector<vector<int>> getIrreducibleTetrahedraIbzqpt() const;
    [[nodiscard]] int getnTetrahedra() const;
    [[nodiscard]] int getnIrredTetrahedra() const;
    [[nodiscard]] double getVolumePerTetrahedron() const;
    [[nodiscard]] const vector<int>& getWeightsTetrahedra() const;
  ...
  private:
    ...
    void findMostCompactTetrahedra(vector<vector<xvector<int>>>&) const;
...
#define _AFLOW_APL_DFPT_DIRECTORY_NAME_ string(ARUN_DIRECTORY_PREFIX + "APL_" + _AFLOW_APL_DFPT_RUNNAME_) // ME20200213
  ...
  private:
    ...
    void estimateUniqueDistortions(const xstructure&, vector<vector<xvector<double>>>&);
    void testDistortion(const xvector<double>&, const vector<_sym_op>&, vector<xvector<double>>&, vector<xvector<double>>&,
  ...
  public:
    ...
    [[nodiscard]] const vector<vector<xmatrix<double>>>& getForceConstants() const;
    [[nodiscard]] const vector<xmatrix<double>>& getBornEffectiveChargeTensor() const;
    [[nodiscard]] const xmatrix<double>& getDielectricTensor() const;
...
// ***************************************************************************
  ...
  private:
    ...
    xmatrix<xcomplex<double>> getNonanalyticalTermWang(const xvector<double>&, vector<xmatrix<xcomplex<double>>>&, bool = true);  // ME20180829
  ...
  public:
    ...
    [[nodiscard]] const vector<vector<xmatrix<double>>>& getHarmonicForceConstants() const;
    [[nodiscard]] const vector<vector<double>>& getAnharmonicForceConstants(int) const;
    [[nodiscard]] const vector<vector<int>>& getClusters(int) const;
    ...
    void setHarmonicForceConstants(const vector<vector<xmatrix<double>>>&, const vector<xmatrix<double>>&, const xmatrix<double>&, bool isPolar = true);// AS20201204
    void awake();
    void setAnharmonicForceConstants(const AnharmonicIFCs&);
    void readAnharmonicIFCs(string);

      // Dynamical Matrix/Frequencies
    xvector<double> getEigenvalues(const xvector<double>&, const xvector<double>&, xmatrix<xcomplex<double>>&, vector<xmatrix<xcomplex<double>>>&, bool = true);  // ME20180827
    ...
    xmatrix<xcomplex<double>> getDynamicalMatrix(const xvector<double>&, const xvector<double>&, vector<xmatrix<xcomplex<double>>>&, bool = true);  // ME20180827
    ...
    xvector<double> getFrequency(const xvector<double>&, const IPCFreqFlags&, xmatrix<xcomplex<double>>&, vector<xvector<double>>&, bool = true);  // ME20180827
    xvector<double> getFrequency(const xvector<double>&, const xvector<double>&, const IPCFreqFlags&, xmatrix<xcomplex<double>>&, vector<xvector<double>>&, bool = true);  // ME20200206
...
// ***************************************************************************
  ...
  public:
    ...
    [[nodiscard]] const std::vector<xvector<double>>& getFreqs() const;  // AS20200312
...
// ***************************************************************************
  ...
  public:
    ...
    [[nodiscard]] const vector<double>& getTemperatures() const;
    [[nodiscard]] const vector<vector<xmatrix<xcomplex<double>>>>& getDisplacementMatrices() const;
    [[nodiscard]] vector<vector<xvector<double>>> getDisplacementVectors() const;
    [[nodiscard]] const vector<vector<vector<xvector<xcomplex<double>>>>>& getModeDisplacements() const;
...
// ***************************************************************************
  ...
  private:
    ...
    [[nodiscard]] int getNumUniqueAtoms(const vector<int>&) const;
    vector<int> getComposition(const vector<int>&);
    [[nodiscard]] bool sameComposition(const vector<int>&, const vector<int>&) const;
    int equivalenceCluster(const vector<int>&, const vector<int>&, const vector<vector<int>>&, const vector<vector<int>>&);
    ...
    [[nodiscard]] int sameDistortions(const _cluster&, const vector<_ineq_distortions>&) const;
    ...
    void appendDistortion(_ineq_distortions&, vector<int>, const int& eq = -1, const int& fg = -1);
    bool allZeroDistortions(const vector<int>&, const vector<int>&);
    bool allAtomsMatch(const int&, const vector<int>&);
    int equivalenceDistortions(const xmatrix<double>&, const vector<int>&, const vector<vector<vector<int>>>&, const vector<int>&);
    ...
    [[nodiscard]] string writeClusters(const vector<_cluster>&) const;
...
// ***************************************************************************
  ...
  public:
    ...
    [[nodiscard]] const string& getDirectory() const;
    void setDirectory(const string&);
    [[nodiscard]] int getOrder() const;

    bool runVASPCalculations(_xinput&, _aflags&, _kflags&, _xflags&);
    bool calculateForceConstants();
    [[nodiscard]] const vector<vector<double>>& getForceConstants() const;
    [[nodiscard]] vector<vector<int>> getClusters() const;
  ...
  private:
    ...
    [[nodiscard]] string buildRunName(const vector<int>&, const vector<int>&, int, int) const;
    void applyDistortions(_xinput&, const vector<xvector<double>>&, const vector<int>&, const vector<int>&, double = 1.0) const;

    [[nodiscard]] vector<vector<int>> getCartesianIndices() const;
    ...
    vector<vector<double>> calculateUnsymmetrizedIFCs(const vector<_ineq_distortions>&, const vector<vector<vector<xvector<double>>>>&);
    [[nodiscard]] double finiteDifference(const vector<vector<xvector<double>>>&, int, const vector<int>&, const vector<int>&) const;
    ...
    void calcSums(const vector<vector<int>>&, const vector<vector<double>>&, vector<vector<double>>&, vector<vector<double>>&);
    void correctIFCs(vector<vector<double>>&, const vector<vector<double>>&, const vector<vector<double>>&, const vector<vector<int>>&, const v4int&);
    vector<double> getCorrectionTerms(const int&, const vector<vector<int>>&, const vector<vector<double>>&, const vector<vector<double>>&, const vector<vector<double>>&);
    [[nodiscard]] uint findReducedCluster(const vector<vector<int>>&, const vector<int>&) const;
...
// ***************************************************************************
  ...
  private:
    ...
    void calculateTransitionProbabilitiesPhonon(int, vector<vector<vector<vector<double>>>>&, const vector<vector<vector<xcomplex<double>>>>&);
    ...
    xmatrix<double> calcTCOND(double, const vector<vector<double>>&, const vector<vector<xvector<double>>>&);
    void getMeanFreeDispFull(const vector<vector<double>>&, const vector<vector<double>>&, vector<vector<xvector<double>>>&);
...
#define QHA_ARUN_MODE "QHA" // used in filename
  ...
  public:
    ...
    QHA(const QHA& qha);
    QHA(const xstructure& struc, _xinput& xinput, xoption& qhaopts, xoption& aplopts, ofstream& FileMESSAGE, ostream& oss = std::cout);
    void initialize(ostream& oss);
    void initialize(ofstream& mf, ostream& oss);
    void initialize(const xstructure& struc, _xinput& xinput, xoption& qhaopts, xoption& aplopts, ofstream& FileMESSAGE, ostream& oss);
    ~QHA();
    ...
    void runSCQHA(EOSmethod method, bool all_iterations_self_consistent = true, const string& directory = ".");
      // output
    void writeThermalProperties(EOSmethod eos_method, QHAmethod qha_method, const string& directory = ".");
    ...
    void writeTphononDispersions(EOSmethod eos_method, QHAmethod qha_method, const string& directory = ".");
  ...
  private:
    ...
    void createSubdirectoriesStaticRun(const _xflags& xflags, const _aflags& aflags, const _kflags& kflags, const vector<vector<bool>>& list);
    int checkStaticCalculations(vector<vector<bool>>& file_is_present);
    void printMissingStaticFiles(const vector<vector<bool>>& list, const vector<string>& subdirectories);
    bool readStaticCalculationsData();
      // related to APL calculations
    void createSubdirectoriesAPLRun(const _xflags& xflags, const _aflags& aflags, const _kflags& kflags, const vector<vector<bool>>& list, QHAtype qhatype);
    ...
    bool readAPLCalculationData(const vector<string>& subdirectories, _kflags& kflags, QHAtype type);
