...
bool SpaceGroupOptionRequired(uint sg) {
  if (sg == 3 || sg == 4 || sg == 5 || sg == 6 || sg == 7 || sg == 8) {
    return true;
  }
  if (sg == 9 || sg == 10 || sg == 11 || sg == 12 || sg == 13 || sg == 14) {
    return true;
  }
  if (sg == 15 || sg == 48 || sg == 50 || sg == 59 || sg == 68 || sg == 70) {
    return true;
  }
  if (sg == 85 || sg == 86 || sg == 88 || sg == 125 || sg == 126 || sg == 129) {
    return true;
  }
  if (sg == 130 || sg == 133 || sg == 134 || sg == 137 || sg == 138 || sg == 141) {
    return true;
  }
  if (sg == 142 || sg == 146 || sg == 148 || sg == 155 || sg == 160 || sg == 161) {
    return true;
  }
  if (sg == 166 || sg == 167 || sg == 201 || sg == 203 || sg == 222 || sg == 224) {
    return true;
  }
  if (sg == 227 || sg == 228) {
    return true;
...
xstructure WyckoffPOSITIONS(uint spacegroup_in, uint option_in, xstructure strin) {
  ...
  if (spacegroup_in < 1 || spacegroup_in > 230) {
    const string message = "Invalid space group " + aurostd::utype2string<uint>(spacegroup_in);
    throw aurostd::xerror(__AFLOW_FILE__, __AFLOW_FUNC__, message, _VALUE_RANGE_);
  }

  if (LDEBUG) {
    cerr << "WyckoffPOSITIONS [0]" << endl;
  }
  ...
  if (LDEBUG) {
    cerr << "WyckoffPOSITIONS [1]" << endl;
  }

  for (size_t i = 0; i < strin.atoms.size(); i++) {
    ...
    if (option != 1 && option != 2) {
      if (spacegroup::SpaceGroupOptionRequired(spacegroup)) {
        SpaceGroupOptionRequired(spacegroup, option);
      }
    ...
    if (spacegroup::SpaceGroupOptionRequired(spacegroup)) {
      str.spacegroupnumberoption = option; // plug option inside
    }
    switch (spacegroup) {
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 70:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(x, y, z);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, -y + 3. / 4, z);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, y, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x, -y + 3. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x, -y, -z);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, y + 1. / 4, -z);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, -y, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x, y + 1. / 4, z + 1. / 4);
            wa(a, str);
          }
        }
        break;
      ...
      case 76:
        ...
        a.fpos = o + wv(-x, -y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(-y, x, z + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(y, -x, z + 3. / 4);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 80:
        ...
        for (uint j = 1; j <= 2; j++) {
          ...
          a.fpos = o + wv(-x + 1. / 2, -y + 1. / 2, z + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-y, x + 1. / 2, z + 1. / 4);
          wa(a, str);
          a.fpos = o + wv(y + 1. / 2, -x, z + 3. / 4);
          wa(a, str);
        }
        break;
      // ----------------------------------------------------------------------------
      ...
      case 85:
        if (option == 1) {
          ...
          a.fpos = o + wv(-x + 1. / 2, -y + 1. / 2, z);
          wa(a, str);
          a.fpos = o + wv(-y + 1. / 2, x, z);
          wa(a, str);
          a.fpos = o + wv(y, -x + 1. / 2, z);
          wa(a, str);
          a.fpos = o + wv(-x, -y, -z);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 2, y + 1. / 2, -z);
      ...
      case 86:
        if (option == 1) {
          ...
          a.fpos = o + wv(-x + 1. / 2, -y + 1. / 2, z);
          wa(a, str);
          a.fpos = o + wv(-y, x + 1. / 2, z + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(y + 1. / 2, -x, z + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-x, -y, -z);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 2, y + 1. / 2, -z);
      ...
      case 88:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 2; j++) {
            ...
            a.fpos = o + wv(y + 1. / 2, -x, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x, -y + 1. / 2, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, y, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y, -x, -z);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 2, x + 1. / 2, -z + 1. / 2);
          ...
          for (uint j = 1; j <= 2; j++) {
            ...
            a.fpos = o + wv(-x + 1. / 2, -y, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, x + 1. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, -x + 3. / 4, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x, -y, -z);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, y, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -x + 3. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, x + 1. / 4, -z + 1. / 4);
            wa(a, str);
          }
        }
        break;
      ...
      case 92:
        ...
        a.fpos = o + wv(-x, -y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(-y + 1. / 2, x + 1. / 2, z + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(y + 1. / 2, -x + 1. / 2, z + 3. / 4);
        wa(a, str);
        a.fpos = o + wv(-x + 1. / 2, y + 1. / 2, -z + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(x + 1. / 2, -y + 1. / 2, -z + 3. / 4);
        wa(a, str);
        a.fpos = o + wv(y, x, -z);
        wa(a, str);
        a.fpos = o + wv(-y, -x, -z + 1. / 2);
      ...
      case 110:
        ...
        for (uint j = 1; j <= 2; j++) {
          ...
          a.fpos = o + wv(-x + 1. / 2, y + 1. / 2, z);
          wa(a, str);
          a.fpos = o + wv(-y, -x + 1. / 2, z + 3. / 4);
          wa(a, str);
          a.fpos = o + wv(y + 1. / 2, x, z + 1. / 4);
          wa(a, str);
        }
        break;
      // ----------------------------------------------------------------------------
      ...
      case 141:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 2; j++) {
            ...
            a.fpos = o + wv(-x + 1. / 2, -y, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, x + 3. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -x + 1. / 4, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 2, y, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(x, -y, -z);
            ...
            a.fpos = o + wv(x + 1. / 2, y, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, -x + 1. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, x + 3. / 4, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, -y, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-x, y, z);
      ...
      case 142:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 2; j++) {
            ...
            a.fpos = o + wv(y + 1. / 2, -x, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 2, y, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x, -y + 1. / 2, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 2, x + 1. / 2, -z);
            wa(a, str);
            a.fpos = o + wv(-y, -x, -z + 1. / 2);
      ...
      case 144:
        ...
        a.fpos = o + wv(x, y, z);
        wa(a, str);
        a.fpos = o + wv(-y, x - y, z + 1. / 3);
        wa(a, str);
        a.fpos = o + wv(-x + y, -x, z + 2. / 3);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 145:
        ...
        a.fpos = o + wv(x, y, z);
        wa(a, str);
        a.fpos = o + wv(-y, x - y, z + 2. / 3);
        wa(a, str);
        a.fpos = o + wv(-x + y, -x, z + 1. / 3);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 151:
        ...
        a.fpos = o + wv(-x + y, -x, z + 2. / 3);
        wa(a, str);
        a.fpos = o + wv(-y, -x, -z + 2. / 3);
        wa(a, str);
        a.fpos = o + wv(-x + y, y, -z + 1. / 3);
        wa(a, str);
        a.fpos = o + wv(x, x - y, -z);
        wa(a, str);
        break;
      ...
      case 152:
        ...
        a.fpos = o + wv(y, x, -z);
        wa(a, str);
        a.fpos = o + wv(x - y, -y, -z + 2. / 3);
        wa(a, str);
        a.fpos = o + wv(-x, -x + y, -z + 1. / 3);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 158:
        ...
        a.fpos = o + wv(-y, -x, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(-x + y, y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(x, x - y, z + 1. / 2);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 161:
        if (option == 1) {
          ...
          a.fpos = o + wv(y, z, x);
          wa(a, str);
          a.fpos = o + wv(z + 1. / 2, y + 1. / 2, x + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(y + 1. / 2, x + 1. / 2, z + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 2, z + 1. / 2, y + 1. / 2);
          wa(a, str);
        } else {
          str.spacegroup = "R3c";
          str.spacegrouplabel = "#161";
      ...
      case 169:
        ...
        a.fpos = o + wv(-x, -y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(y, -x + y, z + 5. / 6);
        wa(a, str);
        a.fpos = o + wv(x - y, x, z + 1. / 6);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 170:
        ...
        a.fpos = o + wv(-x, -y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(y, -x + y, z + 1. / 6);
        wa(a, str);
        a.fpos = o + wv(x - y, x, z + 5. / 6);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 173:
        ...
        a.fpos = o + wv(-x, -y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(y, -x + y, z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(x - y, x, z + 1. / 2);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 178:
        ...
        a.fpos = o + wv(-x, -x + y, -z + 2. / 3);
        wa(a, str);
        a.fpos = o + wv(-y, -x, -z + 5. / 6);
        wa(a, str);
        a.fpos = o + wv(-x + y, y, -z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(x, x - y, -z + 1. / 6);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 179:
        ...
        a.fpos = o + wv(-x, -x + y, -z + 1. / 3);
        wa(a, str);
        a.fpos = o + wv(-y, -x, -z + 1. / 6);
        wa(a, str);
        a.fpos = o + wv(-x + y, y, -z + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(x, x - y, -z + 5. / 6);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 198:
        ...
        a.fpos = o + wv(z, x, y);
        wa(a, str);
        a.fpos = o + wv(z + 1. / 2, -x + 1. / 2, -y);
        wa(a, str);
        a.fpos = o + wv(-z + 1. / 2, -x, y + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(-z, x + 1. / 2, -y + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(y, z, x);
        wa(a, str);
        a.fpos = o + wv(-y, z + 1. / 2, -x + 1. / 2);
        wa(a, str);
        a.fpos = o + wv(y + 1. / 2, -z + 1. / 2, -x);
        wa(a, str);
        a.fpos = o + wv(-y + 1. / 2, -z, x + 1. / 2);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 203:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(z, x, y);
            wa(a, str);
            a.fpos = o + wv(z, -x + 3. / 4, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, -x + 3. / 4, y);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, x, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y, z, x);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, z, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y, -z + 3. / 4, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, -z + 3. / 4, x);
            wa(a, str);
            a.fpos = o + wv(-x, -y, -z);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, y + 1. / 4, -z);
            ...
            a.fpos = o + wv(-z, -x, -y);
            wa(a, str);
            a.fpos = o + wv(-z, x + 1. / 4, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, x + 1. / 4, -y);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, -x, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y, -z, -x);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -z, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y, z + 1. / 4, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, z + 1. / 4, -x);
            wa(a, str);
          }
        }
        break;
      ...
      case 210:
        ...
        for (uint j = 1; j <= 4; j++) {
          ...
          a.fpos = o + wv(-y + 3. / 4, x + 3. / 4, z + 1. / 4);
          wa(a, str);
          a.fpos = o + wv(x + 3. / 4, z + 1. / 4, -y + 3. / 4);
          wa(a, str);
          a.fpos = o + wv(-x + 3. / 4, z + 3. / 4, y + 1. / 4);
          wa(a, str);
          a.fpos = o + wv(-x + 1. / 4, -z + 1. / 4, -y + 1. / 4);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 4, -z + 3. / 4, y + 3. / 4);
          wa(a, str);
          a.fpos = o + wv(z + 3. / 4, y + 1. / 4, -x + 3. / 4);
          wa(a, str);
          a.fpos = o + wv(z + 1. / 4, -y + 3. / 4, x + 3. / 4);
          wa(a, str);
          a.fpos = o + wv(-z + 3. / 4, y + 3. / 4, x + 1. / 4);
          wa(a, str);
          a.fpos = o + wv(-z + 1. / 4, -y + 1. / 4, -x + 1. / 4);
          wa(a, str);
        }
        break;
      // ----------------------------------------------------------------------------
      ...
      case 213:
        ...
        a.fpos = o + wv(-y + 1. / 4, x + 3. / 4, z + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(x + 3. / 4, z + 1. / 4, -y + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(-x + 1. / 4, z + 3. / 4, y + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(-x + 3. / 4, -z + 3. / 4, -y + 3. / 4);
        wa(a, str);
        a.fpos = o + wv(x + 1. / 4, -z + 1. / 4, y + 3. / 4);
        wa(a, str);
        a.fpos = o + wv(z + 3. / 4, y + 1. / 4, -x + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(z + 1. / 4, -y + 1. / 4, x + 3. / 4);
        wa(a, str);
        a.fpos = o + wv(-z + 1. / 4, y + 3. / 4, x + 1. / 4);
        wa(a, str);
        a.fpos = o + wv(-z + 3. / 4, -y + 3. / 4, -x + 3. / 4);
        wa(a, str);
        break;
      // ----------------------------------------------------------------------------
      // ----------------------------------------------------------------------------
      ...
      case 222:
        if (option == 1) {
          ...
          a.fpos = o + wv(-y + 1. / 2, x, z);
          wa(a, str);
          a.fpos = o + wv(x, z, -y + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-x + 1. / 2, z, y);
          wa(a, str);
          a.fpos = o + wv(-x + 1. / 2, -z + 1. / 2, -y + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(x, -z + 1. / 2, y);
          wa(a, str);
          a.fpos = o + wv(z, y, -x + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(z, -y + 1. / 2, x);
          wa(a, str);
          a.fpos = o + wv(-z + 1. / 2, y, x);
          wa(a, str);
          a.fpos = o + wv(-z + 1. / 2, -y + 1. / 2, -x + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-x, -y, -z);
      ...
      case 224:
        if (option == 1) {
          ...
          a.fpos = o + wv(-y, x + 1. / 2, z + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 2, z + 1. / 2, -y);
          wa(a, str);
          a.fpos = o + wv(-x, z + 1. / 2, y + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-x, -z, -y);
          wa(a, str);
          a.fpos = o + wv(x + 1. / 2, -z, y + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(z + 1. / 2, y + 1. / 2, -x);
          wa(a, str);
          a.fpos = o + wv(z + 1. / 2, -y, x + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-z, y + 1. / 2, x + 1. / 2);
          wa(a, str);
          a.fpos = o + wv(-z, -y, -x);
          wa(a, str);
          a.fpos = o + wv(-x, -y, -z);
      ...
      case 227:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(-x + 1. / 4, -y + 1. / 4, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, y + 3. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 3. / 4, -y + 3. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, y + 1. / 4, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 4, -x + 1. / 4, -y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, x + 1. / 4, y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, x + 3. / 4, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 3. / 4, -x + 3. / 4, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, -z + 1. / 4, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, -z + 3. / 4, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, z + 1. / 4, x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, z + 3. / 4, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 2, -x, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y, x, z);
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(x, y, z);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, -y + 1. / 4, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 4, y + 1. / 2, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, -y + 3. / 4, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z, x, y);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 2, -x + 3. / 4, -y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, -x + 1. / 4, y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 4, x + 1. / 2, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y, z, x);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, z + 1. / 2, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 2, -z + 3. / 4, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, -z + 1. / 4, x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, x + 1. / 4, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y, -x, -z);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -x + 1. / 2, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 2, x + 3. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 3. / 4, z + 1. / 4, -y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 2, z + 3. / 4, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x, -z, -y);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, -z + 1. / 2, y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 3. / 4, y + 1. / 4, -x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, -y + 1. / 2, x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 2, y + 3. / 4, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z, -y, -x);
            wa(a, str);
            a.fpos = o + wv(-x, -y, -z);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, y + 3. / 4, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(x + 3. / 4, -y + 1. / 2, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 2, y + 1. / 4, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z, -x, -y);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 2, x + 1. / 4, y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, x + 3. / 4, -y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(z + 3. / 4, -x + 1. / 2, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y, -z, -x);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, -z + 1. / 2, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 2, z + 1. / 4, x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, z + 3. / 4, -x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, -x + 3. / 4, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y, x, z);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, x + 1. / 2, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 2, -x + 1. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 4, -z + 3. / 4, y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, -z + 1. / 4, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x, z, y);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, z + 1. / 2, -y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 4, -y + 3. / 4, x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, y + 1. / 2, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 2, -y + 1. / 4, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z, y, x);
            wa(a, str);
          }
      ...
      case 228:
        if (option == 1) {
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(-z + 1. / 4, -y + 1. / 4, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, -y + 3. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 3. / 4, y + 1. / 4, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, -y + 1. / 4, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 4, y + 3. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, -x + 3. / 4, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 4, x + 3. / 4, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 3. / 4, x + 1. / 4, -y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, -x + 1. / 4, y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, -z + 3. / 4, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -z + 1. / 4, x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, z + 3. / 4, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, z + 1. / 4, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-y, -x + 1. / 2, z);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 2, x + 1. / 2, z + 1. / 2);
          ...
          for (uint j = 1; j <= 4; j++) {
            ...
            a.fpos = o + wv(-y + 1. / 4, -z + 3. / 4, x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y + 3. / 4, x + 1. / 4, -z);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 2, -x + 1. / 2, -z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 4, -x, z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-y, x + 3. / 4, z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 3. / 4, z + 1. / 4, -y);
            wa(a, str);
            a.fpos = o + wv(-x, z + 3. / 4, y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 2, -z + 1. / 2, -y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 4, -z, y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 3. / 4, y + 1. / 4, -x);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 4, -y, x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-z, y + 3. / 4, x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 2, -y + 1. / 2, -x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-x, -y, -z);
            ...
            a.fpos = o + wv(y + 3. / 4, z + 1. / 4, -x + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y + 1. / 4, -x + 3. / 4, z);
            wa(a, str);
            a.fpos = o + wv(y + 1. / 2, x + 1. / 2, z + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-y + 3. / 4, x, -z + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(y, -x + 1. / 4, -z + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(-x + 1. / 4, -z + 3. / 4, y);
            wa(a, str);
            a.fpos = o + wv(x, -z + 1. / 4, -y + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(x + 1. / 2, z + 1. / 2, y + 1. / 2);
            wa(a, str);
            a.fpos = o + wv(-x + 3. / 4, z, -y + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(-z + 1. / 4, -y + 3. / 4, x);
            wa(a, str);
            a.fpos = o + wv(-z + 3. / 4, y, -x + 1. / 4);
            wa(a, str);
            a.fpos = o + wv(z, -y + 1. / 4, -x + 3. / 4);
            wa(a, str);
            a.fpos = o + wv(z + 1. / 2, y + 1. / 2, x + 1. / 2);
            wa(a, str);
          }
...
ostream& operator<<(ostream& oss, const GroupedWyckoffPosition& GroupedWyckoffPosition) {
  ...
  // element
  sscontent_json << R"("element":")" << GroupedWyckoffPosition.element << "\"" << eendl;
  vcontent_json.push_back(sscontent_json.str());
  sscontent_json.str("");
