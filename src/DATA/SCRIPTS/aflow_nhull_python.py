...
class NHull:
    ...
    def get_distance_to_hull(self, alloy, off_hull_point, options = None):
        command = ' --nhull --force --distance_to_hull=' + off_hull_point
        if options:
            command += ' ' + options
        command += ' --print=json --screen_only --alloy=' + alloy
    ...
    def get_stability_criterion(self, alloy, hull_point, options = None):
        command = ' --nhull --force --stability_criterion=' + hull_point
        if options:
            command += ' ' + options
        command += ' --print=json --screen_only --alloy=' + alloy
    ...
    def get_hull_energy(self, alloy, composition, options = None):
        command = ' --nhull --force --hull_energy=' + ','.join([ str(comp) for comp in composition ])
        if options:
            command += ' ' + options
        command += ' --print=json --screen_only --alloy=' + alloy
