...
#ifndef AFLOW_XVASPIN_H
#define AFLOW_XVASPIN_H
...
void LatexSideMarginThesisON(void) {
  std::cout << "\\oddsidemargin -0.25 in " << std::endl;
  std::cout << "\\evensidemargin -0.25 in " << std::endl;
}

void LatexSideMarginThesisOFF(void) {
  std::cout << "\\oddsidemargin 0.2 in " << std::endl;
  std::cout << "\\evensidemargin 0.2 in " << std::endl;
}

void ZungerConversionChart(void);

void Rational(std::ostream& os, double x) {
  if (x < 0) os << "-";
  x = std::abs(x);
  if (aurostd::isequal(x, 0.50000000000000)) {
    os << "1/2";
    return;
  };
  if (aurostd::isequal(x, 0.08333333333333)) {
    os << "1/12";
    return;
  };
  if (aurostd::isequal(x, 0.41666666666667)) {
    os << "5/12";
    return;
  };
  if (aurostd::isequal(x, 0.58333333333333)) {
    os << "7/12";
    return;
  };
  if (aurostd::isequal(x, 0.91666666666667)) {
    os << "11/12";
    return;
  };
  if (aurostd::isequal(x, 1.50000000000000)) {
    os << "3/2";
    return;
  };
  if (aurostd::isequal(x, 2.50000000000000)) {
    os << "5/2";
    return;
  };
  if (aurostd::isequal(x, 0.33333333333333)) {
    os << "1/3";
    return;
  };
  if (aurostd::isequal(x, 0.66666666666666)) {
    os << "2/3";
    return;
  };
  if (aurostd::isequal(x, 1.33333333333333)) {
    os << "4/3";
    return;
  };
  if (aurostd::isequal(x, 1.66666666666666)) {
    os << "5/3";
    return;
  };
  if (aurostd::isequal(x, 2.33333333333333)) {
    os << "7/3";
    return;
  };
  if (aurostd::isequal(x, 2.66666666666666)) {
    os << "8/3";
    return;
  };
  if (aurostd::isequal(x, 0.12500000000000)) {
    os << "1/8";
    return;
  };
  if (aurostd::isequal(x, 0.25000000000000)) {
    os << "1/4";
    return;
  };
  if (aurostd::isequal(x, 0.37500000000000)) {
    os << "3/8";
    return;
  };
  if (aurostd::isequal(x, 0.62500000000000)) {
    os << "5/8";
    return;
  };
  if (aurostd::isequal(x, 0.75000000000000)) {
    os << "3/4";
    return;
  };
  if (aurostd::isequal(x, 0.87500000000000)) {
    os << "7/8";
    return;
  };
  if (aurostd::isequal(x, 0.11111111111111)) {
    os << "1/9";
    return;
  };
  if (aurostd::isequal(x, 0.22222222222222)) {
    os << "2/9";
    return;
  };
  if (aurostd::isequal(x, 0.44444444444444)) {
    os << "4/9";
    return;
  };
  if (aurostd::isequal(x, 0.55555555555555)) {
    os << "5/9";
    return;
  };
  if (aurostd::isequal(x, 0.77777777777777)) {
    os << "7/9";
    return;
  };
  if (aurostd::isequal(x, 0.88888888888888)) {
    os << "8/9";
    return;
  };
  if (aurostd::isequal(x, 1.73205080756888)) {
    os << "\\sqrt{3}";
    return;
  };
  if (aurostd::isequal(x, 2.59807621135332)) {
    os << "3\\sqrt{3}/2";
    return;
  };
  if (aurostd::isequal(x, 1.63299316185545)) {
    os << "\\sqrt{8/3}";
    return;
  };
  if (aurostd::isequal(x, 3.26598632371090)) {
    os << "2\\sqrt{8/3}";
    return;
  };
  if (aurostd::isequal(x, 0.86602540378444)) {
    os << "\\sqrt{3}/2";
    return;
  };
  if (aurostd::isequal(x, 0.16666666666667)) {
    os << "1/6";
    return;
  };
  if (aurostd::isequal(x, 0.83333333333333)) {
    os << "5/6";
    return;
  };
  if (aurostd::isequal(x, 0.10000000000000)) {
    os << "1/10";
    return;
  };
  if (aurostd::isequal(x, 0.20000000000000)) {
    os << "1/5";
    return;
  };
  if (aurostd::isequal(x, 0.30000000000000)) {
    os << "3/10";
    return;
  };
  if (aurostd::isequal(x, 0.40000000000000)) {
    os << "4/10";
    return;
  };
  if (aurostd::isequal(x, 0.60000000000000)) {
    os << "3/5";
    return;
  };
  if (aurostd::isequal(x, 0.70000000000000)) {
    os << "7/10";
    return;
  };
  if (aurostd::isequal(x, 0.80000000000000)) {
    os << "4/5";
    return;
  };
  if (aurostd::isequal(x, 0.90000000000000)) {
    os << "9/10";
    return;
  };
  if (aurostd::isequal(x, 0.05555555555556)) {
    os << "1/18";
    return;
  };
  if (aurostd::isequal(x, 0.27777777777778)) {
    os << "5/18";
    return;
  };
  if (aurostd::isequal(x, 0.38888888888889)) {
    os << "7/18";
    return;
  };
  if (aurostd::isequal(x, 0.61111111111111)) {
    os << "11/18";
    return;
  };
  if (aurostd::isequal(x, 0.72222222222222)) {
    os << "13/18";
    return;
  };
  if (aurostd::isequal(x, 0.94444444444444)) {
    os << "17/18";
    return;
  };
  if (aurostd::isequal(x, 1.41421356237310)) {
    os << "\\sqrt{2}";
    return;
  };
  if (aurostd::isequal(x, 2.23606797749979)) {
    os << "\\sqrt{5}";
    return;
  };
  if (aurostd::isequal(x, 2.64575131106459)) {
    os << "\\sqrt{7}";
    return;
  };
  if (aurostd::isequal(x, 3.16227766016838)) {
    os << "\\sqrt{10}";
    return;
  };
  if (aurostd::isequal(x, 3.31662479035540)) {
    os << "\\sqrt{11}";
    return;
  };
  if (aurostd::isequal(x, 3.46410161513775)) {
    os << "\\sqrt{12}";
    return;
  };
  if (aurostd::isequal(x, 3.60555127546399)) {
    os << "\\sqrt{13}";
    return;
  };
  if (aurostd::isequal(x, 3.74165738677394)) {
    os << "\\sqrt{14}";
    return;
  };
  if (aurostd::isequal(x, 3.87298334620742)) {
    os << "\\sqrt{15}";
    return;
  };
  os << x;
...
void read_VASPIN(std::ostringstream* l, int number, const char* _labels, const char* _strukturbericht, const char* _superstr, const char* _superlatt, const char* _proto, bool VERB) {
  std::ifstream File, FileResult;
  std::ofstream FileOut;
  std::ostringstream aus0, aus1;
  char c = 0, buffer[BUFFER_MAXLEN];// c=` `;
  std::string spacegroup, latticetype, pearson;
  std::string FileName("VASPIN/vasp.in.");
  std::string FileNameResult("/tmp/xresult");
  int AA, BB, pearsonN;
  double volume, volumeP, Cb, a_lat, b_lat, c_lat, alpha_lat, beta_lat, gamma_lat;
  aurostd::xmatrix<double> A(3, 3);
  aurostd::xmatrix<double> Apos(AAmax, 3), Bpos(BBmax, 3);
  int j = 1;
  l[j++] << "& " << _strukturbericht << "\t";
  ;  // STRUKTURBERICHT
  l[j++] << "& " << _proto << "\t";
  ;  // PROTOTYPE
  l[j++] << "& " << _labels << "\t";
  ;  // LABEL
  { // OPEN VASPIN FILE
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);
    aus0 << number;
    if (number == 17) aus0 << ".unrelaxed";
    if (number == 120) aus0 << ".unrelaxed";
    FileName += aus0.str();
    if (VERB) std::cerr << "FILE=[" << FileName << "]" << "  ";
    File.open(FileName.c_str(), std::ios::in);
    if (!File) aurostd::xerror("File not found", FileName.c_str());
  }
  { // GET AA and BB NUMBERS
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus1 << c;
    aus1.seekp(0, std::ios_base::beg);  // RESET
    aus1 << "grep -c BB " << FileName.c_str() << " > " << FileNameResult.c_str() << std::endl;
    ...
    BB = atoi(buffer);
    aus1.seekp(0, std::ios_base::beg);  // RESET
    aus1 << "grep -c AA " << FileName.c_str() << " > " << FileNameResult.c_str() << std::endl;
    system(aus1.str().c_str());
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    FileResult.close();
    AA = atoi(buffer);
    if (VERB) std::cerr << "AA=" << AA << "\t";
    if (VERB) std::cerr << "BB=" << BB << "\t";
    volume = 18.1992 * double(AA) + 22.9326 * double(BB);
    if (VERB) std::cerr << "volume=" << volume << "\t";
  }
  if (AA > AAmax) aurostd::xerror("AA>Amax: ", AA, ">", AAmax);
  if (BB > BBmax) aurostd::xerror("BB>Bmax: ", BB, ">", BBmax);
  if (BB > 0 && BB < AA) aurostd::xerror("BB<AA");
  Cb = (double) BB / (AA + BB);
  { // FORMULA
    l[j] << "& ";
    if (AA == 1) l[j] << "A";
  ...
  { // CREATE VASPIN WITH PARAMETERS
    aus0.seekp(0, std::ios_base::beg);
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cat " << FileName.c_str() << " | sed \"s/AA/Au/g\" | sed \"s/BB/Cd/g\" | sed \"s/SCALExxx/-" << volume << "/g\"> /tmp/vasp.in" << std::endl;
  }
  { // GET SPACEGROUP
    aus0.seekp(0, std::ios_base::beg);
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_spacegroup | sed \"s/#/\\\\\\\\#/g\" " << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    FileResult.close();
    spacegroup += buffer;
    if (VERB) std::cerr << "SG=" << spacegroup << "  ";
    l[j] << "&{\\small " << spacegroup << "}\t";
    j++;
  ...
  { // GET PEARSON_NUMBER
    ...
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_pearsonN" << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    FileResult.close();
    volumeP = atof(buffer + 58);
    if (VERB) std::cerr << "VOLUMEP=" << volumeP << " ";
  ...
  { // GET PEARSON_SYMBOL
    ...
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_pearson" << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    FileResult.close();
    pearson += buffer;
    if (VERB) std::cerr << "PEARSON=" << pearson << pearsonN << "\t";
    l[j] << "& " << pearson << pearsonN << "\t";
    j++;
  }
  { // GET LATTICETYPE
    aus0.seekp(0, std::ios_base::beg);
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_latticetype" << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    FileResult.close();
    latticetype += buffer;
    if (VERB) std::cerr << "LATTICE=" << latticetype << " ";
    //   l[j] << "& " << latticetype << "\t";j++;
    l[j] << "&{\\small  " << latticetype << "}\t";
    j++;
    aus0.seekp(0, std::ios_base::beg);
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_latticetype_abc" << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    a_lat = atof(buffer);// if(VERB) std::cerr << "a_lat=" << a_lat << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    b_lat = atof(buffer);// if(VERB) std::cerr << "b_lat=" << b_lat << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    c_lat = atof(buffer);// if(VERB) std::cerr << "c_lat=" << c_lat << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    alpha_lat = atof(buffer);// if(VERB) std::cerr << "alpha_lat=" << alpha_lat << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    beta_lat = atof(buffer); // if(VERB) std::cerr << "beta_lat=" << beta_lat << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    gamma_lat = atof(buffer);// if(VERB) std::cerr << "gamma_lat=" << gamma_lat << std::endl;
    FileResult.close();
    l[j].precision(4);
    l[j] << "&$(" << a_lat << "," << b_lat << "," << c_lat << ")$\t";
    j++;
    l[j].precision(4);
    l[j] << "&$(" << alpha_lat << "," << beta_lat << "," << gamma_lat << ")$\t";
    j++;
  }
  ...
  { // GET A1 A2 A3
    ...
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_primitive " << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(1, 1) = atof(buffer);// if(VERB) std::cerr << "A(1,1)=" << A(1,1) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(1, 2) = atof(buffer);// if(VERB) std::cerr << "A(1,2)=" << A(1,2) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(1, 3) = atof(buffer);// if(VERB) std::cerr << "A(1,3)=" << A(1,3) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(2, 1) = atof(buffer);// if(VERB) std::cerr << "A(2,1)=" << A(2,1) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(2, 2) = atof(buffer);// if(VERB) std::cerr << "A(2,2)=" << A(2,2) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(2, 3) = atof(buffer);// if(VERB) std::cerr << "A(2,3)=" << A(2,3) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(3, 1) = atof(buffer);// if(VERB) std::cerr << "A(3,1)=" << A(3,1) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(3, 2) = atof(buffer);// if(VERB) std::cerr << "A(3,2)=" << A(3,2) << std::endl;
    FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
    A(3, 3) = atof(buffer);// if(VERB) std::cerr << "A(3,3)=" << A(3,3) << std::endl;
    FileResult.close();
    l[j] << "&\t\t";
    j++;  // primitive vectors
    l[j] << "&$(";
  ...
  { // GET A1 A2 A3
    ...
    for (int i = 0; i < BUFFER_MAXLEN; i++) aus0 << c;
    aus0.seekp(0, std::ios_base::beg);  // RESET
    aus0 << "cd /tmp && /home/auro/work/gndstate/GND_SCRIPTS_AB/BIN/xplato_positions " << " > " << FileNameResult.c_str() << std::endl;
    system(aus0.str().c_str());
    // if(VERB) std::cerr << aus0.str() << "\t";
    FileResult.open(FileNameResult.c_str(), std::ios::in);
    l[j] << "&\t\t";
    ...
    for (int i = 1; i <= AAmax; i++) {
      if (i <= AA) {
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Apos(i, 1) = atof(buffer);
        if (VERB) std::cerr << "Apos(" << i << ",1)=" << Apos(i, 1) << std::endl;
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Apos(i, 2) = atof(buffer);
        if (VERB) std::cerr << "Apos(" << i << ",2)=" << Apos(i, 2) << std::endl;
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Apos(i, 3) = atof(buffer);
        if (VERB) std::cerr << "Apos(" << i << ",3)=" << Apos(i, 3) << std::endl;
        // l[j]<<"& [A]$(";Rational(l[j],Apos(i,1));l[j]<<",";Rational(l[j],Apos(i,2));l[j]<<",";Rational(l[j],Apos(i,3));l[j]<<")$";j++;
        l[j] << "& $(";
        Rational(l[j], Apos(i, 1));
        l[j] << ",";
        Rational(l[j], Apos(i, 2));
        l[j] << ",";
        Rational(l[j], Apos(i, 3));
        l[j] << ")$";
        j++;
      } else {
        // l[j] << "& [A]    $-$     ";j++;
    ...
    for (int i = 1; i <= BBmax; i++) {
      if (i <= BB) {
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Bpos(i, 1) = atof(buffer);
        if (VERB) std::cerr << "Bpos(" << i << ",1)=" << Bpos(i, 1) << std::endl;
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Bpos(i, 2) = atof(buffer);
        if (VERB) std::cerr << "Bpos(" << i << ",2)=" << Bpos(i, 2) << std::endl;
        FileResult.getline(buffer, BUFFER_MAXLEN, '\n');
        Bpos(i, 3) = atof(buffer);
        if (VERB) std::cerr << "Bpos(" << i << ",3)=" << Bpos(i, 3) << std::endl;
        // l[j]<<"& [B]$(";Rational(l[j],Bpos(i,1));l[j]<<",";Rational(l[j],Bpos(i,2));l[j]<<",";Rational(l[j],Bpos(i,3));l[j]<<")$";j++;
        l[j] << "& $(";
        Rational(l[j], Bpos(i, 1));
        l[j] << ",";
        Rational(l[j], Bpos(i, 2));
        l[j] << ",";
        Rational(l[j], Bpos(i, 3));
        l[j] << ")$";
        j++;
      } else {
        // l[j] << "& [B]    $-$     ";j++;
  ...
  // if(VERB) std::cerr << aus0.str() << "\t";
  //   system(aus0.str().c_str());
  if (VERB) std::cerr << std::endl;
}

#define MAXLINESOSTREAM 64

void MakeVaspIn(bool VERB) {
  std::cerr << "% VASP IN PROCEDURE " << std::endl;
  int i, j;
  ...
  std::cerr << "% VASP IN PROCEDURE " << std::endl;
  std::cout << "% VASP IN PROCEDURE " << std::endl;
  std::cout << "\\def\\baselinestretch{1}" << std::endl;
  std::cout << "\\section{{Tables of the structure prototypes}} " << std::endl;
  std::cout << "\\label{appendix.LIST_superstructures} " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** FCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** FCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** FCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** FCC " << std::endl;
  if (_FCC) {
    { // FCC1a TABLE
      std::cerr << "FCC1a TABLE" << std::endl;// FCC1 TABLE
      std::cout << "\\subsection{{FCC superstructures}} " << std::endl;
      std::cout << "\\label{appendix.FCC_superstructures} " << std::endl;
      LatexSideMarginThesisON();
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
      lines[j++] << "Label          ";
      lines[j++] << "Formula        ";
      lines[j++] << "Parent lattice ";
      lines[j++] << "C$_b$          ";
      lines[j++] << "Space Group    ";
      lines[j++] << "Pearson Symbol ";
      lines[j++] << "Lattice type   ";
      lines[j++] << "$(a,b,c)$ (\\AA)";
      lines[j++] << "$(\\alpha,\\beta,\\gamma)$ degrees";
      lines[j++] << "Superlattice   ";
      lines[j++] << "Primitive vectors";
      lines[j++] << "{\\bf a$_1$}/a";
      lines[j++] << "{\\bf a$_2$}/a";
      lines[j++] << "{\\bf a$_3$}/a";
      lines[j++] << "(cartesian)";
      ...
      std::cout << "\\begin{tabular}{||c||c|c|c|c|c||}\\hline\\hline   " << std::endl;
      for (i = 1; i < j; i++) {
        std::string aus = lines[i].str();
        if (i <= i1 || (i > i1 && (((int) aus.find(")")) > 0)) || ((((int) aus.find("posi")) > 0))) {
          if (i != i5 || (int) aus.find("A") > 0) {
            std::cout << lines[i].str();
            if (i <= i2 || i == i1 || i == i3 || i == i4) std::cout << "\\hline";
            std::cout << std::endl;
          }
        }
      }
      //     std::cout << "\\hline \\hline" << std::endl << "\\end{tabular}}" << std::endl << "\\end{center}}" << std::endl;
      std::cout << "\\hline \\hline \\hline \\hline " << std::endl;
    }
    { // FCC1b TABLE
      std::cerr << "FCC1b TABLE" << std::endl; // FCC1b TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
      ...
      // std::cout << "{\\begin{center}" << std::endl;
      // std::cout << "{\\footnotesize" << std::endl;
      // std::cout << "\\begin{tabular}{||c||c|c|c|c|c|c||}\\hline\\hline   " << std::endl;
      for (i = 1; i < j; i++) {
        std::string aus = lines[i].str();
        if (i <= i1 || (i > i1 && (((int) aus.find(")")) > 0)) || ((((int) aus.find("posi")) > 0))) {
          if (i != i5 || (int) aus.find("A") > 0) {
  ...
  if (_FCC) {
    { // FCC2a TABLE
      std::cerr << "FCC2a TABLE" << std::endl; // FCC2 TABLE
      //    std::cout << "\\subsection{FCC2 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // FCC2b TABLE
      std::cerr << "FCC2b TABLE" << std::endl; // FCC4 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_FCC) {
    { // FCC2c TABLE
      std::cerr << "FCC2c TABLE" << std::endl; // FCC2 TABLE
      //    std::cout << "\\subsection{FCC2 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
  ...
  std::cout << "\\newpage" << std::endl;
  if (VERB) std::cerr << " *********************************************************************** BCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** BCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** BCC " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** BCC " << std::endl;
  if (_BCC) {
    {// BCC1a TABLE
      std::cerr << "BCC1a TABLE" << std::endl; // BCC1 TABLE
      std::cout << "\\subsection{{BCC superstructures}} " << std::endl;
      std::cout << "\\label{appendix.BCC_superstructures} " << std::endl;
      LatexSideMarginThesisON();
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
    ...
    { // BCC1b TABLE
      std::cerr << "BCC1b TABLE" << std::endl; // BCC2 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_BCC) {
    { // BCC2 TABLE
      std::cerr << "BCC2a TABLE" << std::endl; // BCC2 TABLE
      // std::cout << "\\subsection{BCC2a superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // BCC2b TABLE
      std::cerr << "BCC2b TABLE" << std::endl; // BCC4 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_BCC) {
    { // BCC2c TABLE
      std::cerr << "BCC2c TABLE" << std::endl; // BCC2 TABLE
      //    std::cout << "\\subsection{BCC2 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  LatexSideMarginThesisOFF();
  std::cout << "\\newpage" << std::endl;
  if (VERB) std::cerr << " *********************************************************************** HCP " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** HCP " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** HCP " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** HCP " << std::endl;
  if (_HCP) {
    { // HCP1a TABLE
      std::cout << "\\subsection{{HCP superstructures}} " << std::endl;
      std::cout << "\\label{appendix.HCP_superstructures} " << std::endl;
      LatexSideMarginThesisON();
      std::cerr << "HCP1a TABLE" << std::endl; // HCP1 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
      ...
      std::cout << "{\\begin{center}" << std::endl;
      std::cout << "{\\footnotesize" << std::endl;
      std::cout << "\\begin{tabular}{||c||c|c|c|c||}\\hline\\hline   " << std::endl;
      for (i = 1; i < j; i++) {
        std::string aus = lines[i].str();
        if (i <= i1 || (i > i1 && (((int) aus.find(")")) > 0)) || ((((int) aus.find("posi")) > 0))) {
          if (i != i5 || (int) aus.find("A") > 0) {
    ...
    { // HCP1b TABLE
      std::cerr << "HCP1b TABLE" << std::endl; // HCP2 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_HCP) {
    { // HCP2a TABLE
      std::cerr << "HCP2a TABLE" << std::endl; // HCP3 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // HCP2b TABLE
      std::cerr << "HCP2b TABLE" << std::endl; // HCP3 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_HCP) {
    { // HCP3a TABLE
      std::cerr << "HCP3a TABLE" << std::endl; // HCP3 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  LatexSideMarginThesisOFF();
  std::cout << "\\newpage" << std::endl;
  if (VERB) std::cerr << " *********************************************************************** EXT " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** EXT " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** EXT " << std::endl;
  if (VERB) std::cerr << " *********************************************************************** EXT " << std::endl;
  if (_EXT) {
    std::cout << "\\subsection{{EXTRA structures}} " << std::endl;
    std::cout << "\\label{appendix.EXTRA_superstructures} " << std::endl;
    LatexSideMarginThesisON();
    { // EXT1a TABLE
      std::cerr << "EXT1a TABLE" << std::endl;// EXT1 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // EXT1b TABLE
      std::cerr << "EXT1b TABLE" << std::endl; // EXT2 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_EXT) {
    { // EXT2a TABLE
      std::cerr << "EXT2a TABLE" << std::endl;// EXT2a TABLE
      // std::cout << "\\subsection{EXT2a superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // EXT2b TABLE
      std::cerr << "EXT2b TABLE" << std::endl; // EXT4 TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_EXT) {
    {  // EXT3a TABLE
      std::cerr << "EXT3a TABLE" << std::endl;// EXT3a TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // EXT3b TABLE
      std::cerr << "EXT3b TABLE" << std::endl; // EXT3b TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_EXT) {
    {  // EXT4a TABLE
      std::cerr << "EXT4a TABLE" << std::endl;// EXT4a TABLE
      // std::cout << "\\subsection{EXT7 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // EXT4b TABLE
      std::cerr << "EXT4b TABLE" << std::endl; // EXT4b TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_EXT) {
    { // EXT5a TABLE
      std::cerr << "EXT5a TABLE" << std::endl;// EXT5a TABLE
      // std::cout << "\\subsection{EXT9 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
    ...
    { // EXT5b TABLE
      std::cerr << "EXT5b TABLE" << std::endl; // EXT5b TABLE
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      lines[j++] << "Prototype      ";
  ...
  if (_EXT) {
    { // EXT6a TABLE
      std::cerr << "EXT6a TABLE" << std::endl;// EXT5a TABLE
      // std::cout << "\\subsection{EXT9 superstructures} " << std::endl;
      std::ostringstream lines[MAXLINESOSTREAM];
      j = 1;
      lines[j++] << "Strukturbericht";
      ...
      //   }
      //   { // EXT6b TABLE
      //   std::cerr << "EXT6b TABLE" << std::endl; // EXT5b TABLE
      //   std::ostringstream lines[MAXLINESOSTREAM];
      //   j=1;
  ...
  std::cerr << " *********************************************************************** END " << std::endl;
  LatexSideMarginThesisOFF();
  // cout << "\\end{document}" << std::endl;
}

void ZungerConversionChart(void) {
  std::cout << " \\subsection{Conversion chart for FCC/BCC/HCP superstructures}                   " << std::endl;
  std::cout << "{\\large                                                                       " << std::endl;
  std::cout << "  \\begin{center}                                                              " << std::endl;
  std::cout << "    DEFINITION:                                                                " << std::endl;
  std::cout << "    \\begin{itemize}                                                           " << std::endl;
  std::cout << "    \\item{}XXX$_{SSS}^{[DIR]}$                                                " << std::endl;
  std::cout << "    \\item{}XXX=parent lattice                                                 " << std::endl;
  std::cout << "    \\item{}SSS=stacking                                                       " << std::endl;
  std::cout << "    \\item{}DIR=stacking direction                                             " << std::endl;
  std::cout << "    \\end{itemize}                                                             " << std::endl;
  std::cout << "    \\begin{tabular}{|c|c|c|}\\hline                                           " << std::endl;
  std::cout << "      {\\it unusual} name   & plain formalism (s)         & label \\\\ \\hline " << std::endl;
  std::cout << "      $\\beta1/\\beta2$      & FCC$_{AB2}^{[100]}$         & 5,6 \\\\ \\hline  " << std::endl;
  std::cout << "      $\\alpha1/\\alpha2$    & FCC$_{AB2}^{[111]}$         & 9,10 \\\\ \\hline " << std::endl;
  std::cout << "      Z1/Z3                & FCC$_{AB3}^{[001]}$         & 13,15 \\\\ \\hline  " << std::endl;
  std::cout << "      Z2                   & FCC$_{A2B2}^{[001]}$        & 14 \\\\ \\hline     " << std::endl;
  std::cout << "      W2                   & FCC$_{A2B2}^{[311]}$        & 17 \\\\ \\hline     " << std::endl;
  std::cout << "      Y1/Y3                & FCC$_{AB3}^{[011]}$         & 19,21 \\\\ \\hline  " << std::endl;
  std::cout << "      Y2                   & FCC$_{A2B2}^{[011]}$        & 20 \\\\ \\hline     " << std::endl;
  std::cout << "      CH or 40             & FCC$_{A2B2}^{[201]}$        & 23 \\\\ \\hline     " << std::endl;
  std::cout << "      V1/V3                & FCC$_{AB3}^{[111]}$         & 27,29 \\\\ \\hline  " << std::endl;
  std::cout << "      V2                   & FCC$_{A2B2}^{[111]}$        & 28 \\\\ \\hline     " << std::endl;
