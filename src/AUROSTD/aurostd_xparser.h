...
namespace aurostd {
  ...
  std::vector<std::string> getElements(const std::string& input, elements_string_type e_str_type, bool clean = true, bool sort_elements = false, bool keep_pp = false, std::ostream& oss = std::cout);
  template <class utype>
  std::vector<std::string> getElements(const std::string& input, std::vector<utype>& vcomposition, bool clean = true, bool sort_elements = false, bool keep_pp = false, std::ostream& oss = std::cout);
  std::vector<std::string> getElements(const std::string& input, elements_string_type e_str_type, std::ofstream& FileMESSAGE, bool clean = true, bool sort_elements = false, bool keep_pp = false, std::ostream& oss = std::cout);
  template <class utype>
  std::vector<std::string> getElements(const std::string& input, std::vector<utype>& vcomposition, elements_string_type e_str_type, bool clean = true, bool sort_elements = false, bool keep_pp = false, std::ostream& oss = std::cout);
  template <class utype>
  std::vector<std::string> getElements(
      const std::string& input, std::vector<utype>& vcomposition, elements_string_type e_str_type, std::ofstream& FileMESSAGE, bool clean = true, bool sort_elements = false, bool keep_pp = false, std::ostream& oss = std::cout);
} // namespace aurostd
