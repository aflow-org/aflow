...
namespace aurostd {
  ...
  public:
    ...
    xcomplex& operator*=(const xcomplex&);
    xcomplex& operator/=(const xcomplex&);
    bool operator==(const xcomplex&);
    bool operator<(const xcomplex&);
    bool operator>(const xcomplex&);
    bool operator<=(const xcomplex&);
    bool operator>=(const xcomplex&);
    [[nodiscard]] utype real() const { return re; }
    [[nodiscard]] utype imag() const { return im; }
        //  private:
    utype re, im;
  ...
  // ----------------------------------------------- operator xcomplex / xcomplex
  template <class utype> xcomplex<utype> operator/(const xcomplex<utype>&, const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------- operator utype / xcomplex
  template <class utype> xcomplex<utype> operator/(utype, const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------- operator xcomplex / utype
  template <class utype> xcomplex<utype> operator/(const xcomplex<utype>& x, utype y) __xprototype;
  ...
  // ------------------------------------------------------------- function cos
  template <class utype> xcomplex<utype> cos(const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------ function cosh
  template <class utype> xcomplex<utype> cosh(const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------- function exp
  template <class utype> xcomplex<utype> exp(const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------- function log
  template <class utype> xcomplex<utype> log(const xcomplex<utype>&) __xprototype;

  // --------------------------------------------- function xcomplex pow xcomplex
  template <class utype> xcomplex<utype> pow(const xcomplex<utype>&, const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------- function xcomplex pow int
  template <class utype> xcomplex<utype> pow(const xcomplex<utype>&, int) __xprototype;

  // ----------------------------------------------- function xcomplex pow utype
  template <class utype> xcomplex<utype> pow(const xcomplex<utype>&, utype) __xprototype;

  // ----------------------------------------------- function utype pow xcomplex
  template <class utype> xcomplex<utype> pow(utype, const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------- function sin
  template <class utype> xcomplex<utype> sin(const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------ function sinh
  template <class utype> xcomplex<utype> sinh(const xcomplex<utype>&) __xprototype;

  // ------------------------------------------------------------ function sqrt
  template <class utype> xcomplex<utype> sqrt(const xcomplex<utype>&) __xprototype;

  // ME20180907
  //  ------------------------------------------------------------ function magnitude square
  template <class utype> utype magsqr(const xcomplex<utype>&) __xprototype;
